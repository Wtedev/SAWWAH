...
Route::get('/events/country/{country}', [EventPublicController::class, 'filterByCountry'])->name('events.country');

//event المشرف
Route::prefix('admin')->middleware(['auth', 'is_admin'])->group(function () {
    Route::resource('events', EventAdminController::class)->names('admin.events');
});