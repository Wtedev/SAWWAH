            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105">
                <div class="flex flex-col md:flex-row-reverse">
                    ...
                    <div class="md:w-1/2 p-6 text-right">
                        <h2 class="text-xl font-bold text-gray-900 mb-2">اسم الوجهه</h2>
                        <p class="text-gray-600 text-sm mb-4">ضع هنا نص يصف الوجهه بشكل مبسط جداً. ضع هنا نص يصف الوجهه بشكل مبسط جداً.</p>
