                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="group relative bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-lg transition-shadow">
                                <div class="aspect-w-16 aspect-h-9">
                                    <img src="{{ asset('images/' . $event->image) }}" alt="{{ $event->name }}" class="w-full h-48 object-cover group-hover:opacity-75 transition-opacity">
                                </div>
                                <div class="p-4">
                                    ...
                                    <div class="mt-4 flex flex-wrap items-center justify-between gap-2">
                                        ...
                                        <a href="{{ route('events.show', $event) }}" class="text-sm font-medium text-pink-600 hover:text-pink-500">
                                            التفاصيل →
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    <img src="https://openweathermap.org/img/wn/{{ $weather['icon'] }}@2x.png" alt="Weather Icon" class="w-20 h-20">
                                    <div class="mr-4">
